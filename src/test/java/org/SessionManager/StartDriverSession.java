...
public class StartDriverSession {
    ...
    public static AppiumDriver initializeDriver(String platformName) throws Exception {
        ...
        switch (platformName) {
            ...
            case "Android":
                caps.setCapability(MobileCapabilityType.DEVICE_NAME, "Pixel 7 Pro");
                caps.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UiAutomator2");
                caps.setCapability(MobileCapabilityType.UDID, "emulator-5554");

                String andappUrl = System.getProperty("user.dir") + File.separator + "src" + File.separator
                        + File.separator
                        + "resources" + File.separator + "staging.apk";
                caps.setCapability("appPackage", "com.hushed.staging");
                caps.setCapability("appActivity", "com.hushed.base.landing.SplashActivity");
            ...
            case "iOS":
                ...
                String iOSappUrl = System.getProperty("user.dir") + File.separator + "src" + File.separator
                        + File.separator
                        + "resources" + File.separator + "v6-staging-debug..apk";
                caps.setCapability("appPackage", "com.hushed.staging");
                caps.setCapability("appActivity", "com.hushed.base.landing.SplashActivity");
